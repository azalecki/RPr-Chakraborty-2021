...
study_state <- filter(state, STATEFP == '12'  | STATEFP == '13' | STATEFP == '01' | STATEFP == '45') 

tm_gee_residualclusters <- tm_shape(gee_resid) + 
  tm_polygons(col= "ss_clusID", pal = c("red", "skyblue", "white"))
